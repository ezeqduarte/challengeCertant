...
export default function PopUpPokemon({ pokemonEdit, popUp, setPopUp }) {
  ...
  return (
    <>
      <div className="fixed w-screen h-screen bg-black/70"></div>

      <div className="flex flex-col border rounded fixed top-10 left-0 bottom-0 overflow-y-scroll right-0 m-auto border-3 p-[2rem] w-[400px] h-[550px] bg-white  ">
        ...
        <form onSubmit={submitPokemon} className="flex flex-col gap-3">
          <label className="w-full gap-3 flex justify-between items-center">
            ...
            <input
              ...
              className="grow border bg-slate-100 p-1"
              type="text"
              value={name}
              required
            />
          ...
          <label className="flex flex-col">
            ...
            <input
              ...
              className="grow border bg-slate-100 py-1"
              type="text"
              value={image}
              required
            />
          ...
          {abilities.map((ability, index) => (
            <Fragment key={`abilityInput${index}`}>
              <fieldset className="grow border flex flex-col gap-3 px-1 py-1">
                ...
                <textarea
                  ...
                  required
                  className="grow border bg-slate-100 block resize-none"
                  rows="3"
                >
                  Description
                </textarea>
          ...
          {evolutions.map((evolution, index) => (
            <Fragment key={`evolutionsInput${index}`}>
              <fieldset className="grow border flex flex-col gap-3 px-1 py-1">
                <label className="w-full flex flex-col ">
                  ...
                  <input
                    ...
                    className="grow bg-slate-100 border p-1"
                    type="text"
                    required
                  />
                </label>
                ...
                <label className="w-full flex flex-col ">
                  ...
                  <input
                    ...
                    className="grow border bg-slate-100"
                    type="text"
                    required
                  />
                </label>
